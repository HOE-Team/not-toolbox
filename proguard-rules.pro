# =============================================================================
# NOT Toolbox - ProGuard rules
# Shrink only: disable BOTH obfuscation and optimization.
# Obfuscation renames classes and breaks skiko/skia native JNI binding,
# causing EXCEPTION_ACCESS_VIOLATION crash at startup (Library._nAfterLoad).
# =============================================================================
